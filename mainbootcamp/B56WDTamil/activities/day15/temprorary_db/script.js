...
let radio1 = createInputElement("form-check-input", "radio", "genter", "gender");
radio1.value = "Male";

let radio2 = createInputElement("form-check-input", "radio", "genter", "gender");
radio2.value = "Female";
...
food.append(foodlabel, checkBox1, checkBox2, checkBox3, checkBox4)
