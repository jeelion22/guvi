...
(function (arr) {
    console.log(`The odd number(s) from the array [${arr}]: `);
...
const palindromeArray = (function (arr){
    ...
    return palindromes
})(["radar", "Deed", "Level", "Jeeva", 22, "121", -121])

console.log(palindromeArray) // [ 'radar', 'Deed', 'Level', 22, '121', -121 ]
...
const getMedianOfTwoSortedArrays = (function (arr1, arr2) {
    ...
    while (true) {
        ...
        if (Aleft <= Bright && Bleft <= Aright){
            // resultant array always be even as both arrays equal lengths
...
console.log(getMedianOfTwoSortedArrays) // 3.5
...
console.log(removeDuplicates) // [ 1, 2, 5, -1 ]
...
console.log(leftRotate) // [ 2, 3, 4, 5, 1 ]
...
console.log(rightRotate) // [ 4, 1, 2, 3 ]
